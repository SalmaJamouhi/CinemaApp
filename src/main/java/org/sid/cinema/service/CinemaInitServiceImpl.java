...
public class CinemaInitServiceImpl implements ICinemaInitService {
	...
	public void initFilms() {
		...
		Stream.of("Harry Potter 5","Harry Potter","Harry Potter 2","Harry Potter 3","Harry Potter 4","Harry Potter 6","Harry Potter 7","Harry Potter 8","To the bone","Avatar","Twilight","Lord of the rings", "Suicide Squad")
		.forEach(nameFilm->{
		Film film=new Film();
